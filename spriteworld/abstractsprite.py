...
CODES = {
  'triangle': [mpl_path.Path.MOVETO, mpl_path.Path.LINETO, mpl_path.Path.CLOSEPOLY],
  'square': [mpl_path.Path.MOVETO, mpl_path.Path.LINETO, mpl_path.Path.LINETO, mpl_path.Path.CLOSEPOLY],
  'circle': None
}
...
class AbstractSprite(object):
  ...
  def _reset_centered_path(self):
    vertices = constants.SHAPES[self._shape]
    path = mpl_path.Path(vertices, CODES[self._shape])
    scale_rotate = (
  ...
  def _circle_circle_overlap(self, other, direction):
    ...
    if direction == "down":
      ...
      if p2.__class__.__name__ == "LineString" and list(p2.coords):
        ...
        try: self._position[1] += p2.y - p1.y + 1e-4
        except: pass 
    elif direction == "up":
      ...
      if p2.__class__.__name__ == "LineString" and list(p2.coords):
        p2 = Point([p for p in list(p2.coords) if Point(p) != p1][0])
        try: self._position[1] -= p1.y - p2.y + 1e-4
        except: pass
      ...
      if p2.__class__.__name__ == "LineString" and list(p2.coords):
        p2 = Point([p for p in list(p2.coords) if Point(p) != p1][0])
        try: self._position[0] -= p1.x - p2.x + 1e-4
        except: pass
    else:
      ...
      if p2.__class__.__name__ == "LineString" and list(p2.coords):
        p2 = Point([p for p in list(p2.coords) if Point(p) != p1][0])
        try: self._position[0] += p2.x - p1.x + 1e-4
        except: pass
  ...
  def _circle_square_overlap(self, other, direction):
    ...
    if direction == "down":
      if other.vertices[1][0] > self.x:
        ...
        try: self._position[1] += other.vertices[1][1] - p.y + 1e-4
        except: pass
      elif other.vertices[0][0] < self.x:
        line1 = LineString([other.vertices[0], other.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[1] += other.vertices[0][1] - p.y + 1e-4
        except: pass
      else: 
        self._position[1] += other.bounds[3] - (self.y - self.prop) + 1e-4
    elif direction == "up":
      if other.vertices[2][0] > self.x:
        line1 = LineString([other.vertices[1], other.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[1] -= p.y - other.vertices[2][1] + 1e-4
        except: pass
        ...
        self._position[1] -= (self.y + self.prop) - other.bounds[1] + 1e-4
    elif direction == "right":
      if other.vertices[1][1] < self.y:
        line1 = LineString([other.vertices[0], other.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] -= p.x - other.vertices[1][0] + 1e-4
        except: pass
      elif other.vertices[2][1] > self.y:
        line1 = LineString([other.vertices[2], other.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[0] -= p.x - other.vertices[2][0] + 1e-4
        except: pass
      else:
        self._position[0] -= (self.x + self.prop) - other.bounds[0]  + 1e-4
    else:
      if other.vertices[0][1] < self.y:
        line1 = LineString([other.vertices[0], other.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] += other.vertices[0][0] - p.x + 1e-4
        except: pass
      elif other.vertices[3][1] > self.y:
        line1 = LineString([other.vertices[2], other.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[0] += other.vertices[3][0] - p.x + 1e-4
        except: pass
      else:
        self._position[0] += other.bounds[2] - (self.x - self.prop)  + 1e-4
  ...
  def _square_circle_overlap(self, other, direction):
    ...
    if direction == "down":
      if self.vertices[3][0] < other.x:
        ...
        p = line1.intersection(circle)
        try: self._position[1] += p.y - self.vertices[3][1] + 1e-4
        except: pass
      elif self.vertices[2][0] > other.x:
        line1 = LineString([self.vertices[1], self.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[1] += p.y - self.vertices[2][1] + 1e-4
        except: pass
      else: self._position[1] += (other.y + other.prop) - self.bounds[1] + 1e-4
    elif direction == "up":
      if self.vertices[1][0] > other.x:
        line1 = LineString([self.vertices[1], self.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[1] -= self.vertices[1][1] - p.y + 1e-4
        except: pass
      elif self.vertices[0][0] < other.x:
        line1 = LineString([self.vertices[0], self.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[1] -= self.vertices[0][1] - p.y + 1e-4
        except: pass
      else:
        self._position[1] -= self.bounds[3] - other.bounds[1] + 1e-4
    elif direction == "right":
      if self.vertices[0][1] < other.y:
        line1 = LineString([self.vertices[0], self.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] -= self.vertices[0][0] - p.x + 1e-4
        except: pass
      elif self.vertices[3][1] > other.y:
        line1 = LineString([self.vertices[2], self.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[0] -= self.vertices[3][0] - p.x + 1e-4
        except: pass
      else: self._position[0] -= self.bounds[2] - (other.x - other.prop) + 1e-4
    else:
      if self.vertices[1][1] < other.y:
        line1 = LineString([self.vertices[0], self.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] += p.x - self.vertices[1][0] + 1e-4
        except: pass
      elif self.vertices[2][1] > other.y:
        line1 = LineString([self.vertices[2], self.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[0] += p.x - self.vertices[2][0] + 1e-4
        except: pass
      else: self._position[0] += (other.x + other.prop) - self.bounds[0] + 1e-4

  def _square_square_overlap(self, other, direction):
    if direction == "down":
      if other.bounds[3] >= self.bounds[1]:
        self._position[1] += other.bounds[3] - self.bounds[1] + 1e-4
    elif direction == "up":
      if self.bounds[3] >= other.bounds[1]:
        self._position[1] -= self.bounds[3] - other.bounds[1] + 1e-4
    elif direction == "right":
      if self.bounds[2] >= other.bounds[0]:  
        self._position[0] -= self.bounds[2] - other.bounds[0] + 1e-4
    else:
      if other.bounds[2] >= self.bounds[0]:
        self._position[0] += other.bounds[2] - self.bounds[0] + 1e-4

  def _circle_triangle_overlap(self, other, direction):
    r = self.prop
    if direction == "down":
      if not (self.x - r >= other.vertices[0][0] or self.x + r <= other.vertices[0][0]):
        if other.bounds[3] > self.y - r: self._position[1] += other.bounds[3] - (self.y - r)  + 1e-4
      else:
        ...
        if line3.intersects(self.contours):
          d2 = other.vertices[0][1] - line3.intersection(self.contours).bounds[1] + 1e-4
        self._position[1] += max(d1, d2)   
    elif direction == "up":
      if other.vertices[2][0] < self.x:
        line1 = LineString([other.vertices[2], (other.vertices[2][0], 1)])
        point = line1.intersection(self.contours)        
        try: self._position[1] -= point.bounds[3]  - other.vertices[2][1] + 1e-4
        except: pass
      elif other.vertices[1][0] > self.x:
        line1 = LineString([other.vertices[1], (other.vertices[1][0], 1)])
        point = line1.intersection(self.contours)
        try: self._position[1] -= point.bounds[3]  - other.vertices[1][1] + 1e-4
        except: pass
      else: self._position[1] -= self.bounds[3] - other.bounds[1]
    elif direction == "right":
      if self.bounds[1] == other.bounds[1]:
        line1 = LineString([other.vertices[0], other.vertices[1]])
        line2 = LineString([(0, self.y), (self.bounds[2], self.y)])
        point = line1.intersection(line2)
        try: self._position[0] -= self.bounds[2]  - point.x + 1e-4
        except: pass
      elif self.y - r <= other.vertices[0][1] and self.y - r > other.vertices[1][1]:
        p = self.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
        line1 = LineString([(0, self.y), p]) 
        line2 = LineString([other.vertices[0], other.vertices[1]])
        point = line1.intersection(line2)
        try: self._position[0] -= p[0] - point.x + 1e-4
        except: pass
      else:
        line1 = LineString([other.vertices[1], other.vertices[2]])
      ...
      if self.bounds[1] == other.bounds[1]:
        line1 = LineString([other.vertices[0], other.vertices[2]])
        line2 = LineString([(self.bounds[0], self.y), (1, self.y)])
        point = line1.intersection(line2)
        try: self._position[0]+= point.x - self.bounds[0] + 1e-4
        except: pass
      elif self.y - r <= other.vertices[0][1] and self.y -r > other.vertices[2][1]:
        p = self.position + (r * np.cos((5*np.pi)/4), r * np.sin((5*np.pi)/4))
        line1 = LineString([p, (1, self.y)])
        line2 = LineString([other.vertices[0], other.vertices[2]])
        point = line1.intersection(line2)
        try: self._position[0] += point.x - p[0] + 1e-4
        except: pass
      else:
        line1 = LineString([other.vertices[1], other.vertices[2]])
        p = line1.intersection(self.contours)
        try: self._position[0] += other.vertices[2][0] - p.bounds[2]  + 1e-4
        except: pass
  ...
  def _square_triangle_overlap(self, other, direction):
    ...
    if direction == "down":
      if self_vert[3][0] < other_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] += point.y  - self_vert[3][1] + 1e-4
        except: pass
      elif self_vert[2][0] > other_vert[0][0]:
        line1 = LineString([other_vert[0], other_vert[2]])
        line2 = LineString([self_vert[2], (self_vert[2][0], 1)])
        point = line1.intersection(line2)
        try: self._position[1] += point.y  - self_vert[2][1] + 1e-4
        except: pass
      else: self._position[1] += other.bounds[3] - self.bounds[1] + 1e-4
      ...
      if self.bounds[1] >= other.bounds[1]: 
        ...
        point = line1.intersection(line2)
        try: self._position[0] -= self_vert[3][0] - point.x + 1e-4
        except: pass
      else: self._position[0] -= self.bounds[2] - other.bounds[0] + 1e-4
    else:
      if self.bounds[1] >= other.bounds[1]:
        line1 = LineString([other_vert[0], other_vert[2]])
        line2 = LineString([self_vert[2], (1, self_vert[2][1])])
        point = line1.intersection(line2)
        try: self._position[0] += point.x - self_vert[2][0] + 1e-4
        except: pass
      else: self._position[0] += other.bounds[2] - self.bounds[0] + 1e-4
    ...
    if direction == "down":
      ...
      if not (other.x + 0.02 <= self.vertices[0][0] or other.x - 0.02 >= self.vertices[0][0]):   
        ...
        if line3.intersects(other.contours):
          d2 = self.vertices[0][1] - line3.intersection(other.contours).bounds[1] + 1e-4
      ...
      if self.vertices[2][1] >= other.y + r * np.sin((5*np.pi)/4):
        ...
        if p1: self._position[0] -= self.vertices[2][0] - p1[0][0] + 1e-4
        ...
        if p1: self._position[0] -= self.vertices[0][0] - p1[0][0] + 1e-4
      else:
        p = other.position + (r * np.cos((5*np.pi)/4), r * np.sin((5*np.pi)/4))
      ...
      if self.vertices[1][1] >= other.y + r * np.sin((7*np.pi)/4):
        ...
        if p1: self._position[0] += p1[0][0] - self.vertices[1][0] + 1e-4
        ...
        p1 = [p for p in list(p1.coords) if Point(p) != Point(self.vertices[0])]
        if p1: self._position[0] += p1[0][0] - self.vertices[0][0] + 1e-4
      else:
        p = other.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
  ...
  def _triangle_square_overlap(self, other, direction):
    ...
    if direction == "down": self._position[1] += other.bounds[3] - self.bounds[1] + 1e-5
      ...
      if other_vert[3][0] < self_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] -= point.y - other_vert[3][1] + 1e-4
        except: pass
      elif other_vert[2][0] > self_vert[0][0]:
        line1 = LineString([self_vert[0], self_vert[2]])
        line2 = LineString([other_vert[2], (other_vert[2][0], 1)])
        point = line1.intersection(line2)
        try: self._position[1] -= point.y - other_vert[2][1] + 1e-4
        except: pass
      else: self._position[1] -= self.bounds[3] - other.bounds[1] + 1e-4
    elif direction == "right":
      if self.bounds[1] >= other.bounds[1]:
        self._position[0] -= self.bounds[2] - other.bounds[0] + 1e-4
      else:
        ...
        point = line1.intersection(line2)
        try: self._position[0] -= point.x - other_vert[2][0] + 1e-4
        except: pass
    else:
      if self.bounds[1] >= other.bounds[1]:
        self._position[0] += other.bounds[2] - self.bounds[0] + 1e-4
        ...
        point = line1.intersection(line2)
        try: self._position[0] += other_vert[3][0] - point.x + 1e-4
        except: pass
    del self_vert, other_vert
  ...
  def _triangle_triangle_overlap(self, other, direction):
    ...
    if direction == "down":
      if self_vert[2][0] < other_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] += point.y - self_vert[1][1] + 1e-4
        except: pass
      else:
      ...
      if other_vert[2][0] < self_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] -= point.y- other_vert[1][1] + 1e-4
        except: pass
      else:
      ...
      if self.bounds[1] > other.bounds[1]:
        ...
        line2 = LineString([other_vert[0], other_vert[1]])
        point = line1.intersection(line2)
        try: self._position[0] -= self_vert[2][0] - point.x + 1e-4
        except: pass
      elif self.bounds[1] < other.bounds[1]:
        line1 = LineString([other_vert[1], (1, other_vert[1][1])])
        line2 = LineString([self_vert[0], self_vert[2]])
        point = line1.intersection(line2)
        try: self._position[0] -= point.x - other_vert[1][0] + 1e-4
        except: pass
      else:
        if other.bounds[0] < self.bounds[2]: self._position[0] -= self.bounds[2] - other.bounds[0] + 1e-4
    else:
      if self.bounds[1] > other.bounds[1]:
        line1 = LineString([self_vert[1], (1, self_vert[1][1])])
        line2 = LineString([other_vert[0], other_vert[2]])
        point = line1.intersection(line2)
        try: self._position[0] += point.x - self_vert[1][0] + 1e-4
        except: pass
      elif self.bounds[1] < other.bounds[1]:
        line1 = LineString([(0, other_vert[2][1]), other_vert[2]])
        line2 = LineString([self_vert[0], self_vert[1]])
        point = line1.intersection(line2)
        try: self._position[0] += other_vert[2][0]- point.x + 1e-4
        except: pass
      else:
        if other.bounds[2] > self.bounds[0]: self._position[0] += other.bounds[2] - self.bounds[0] + 1e-4
    del self_vert, other_vert
  ...
  def _handle_circle_circle(self, other, direction):
    ...
    if direction == "down": self._position[1] -= p1.y - p2.y - 1e-4
    elif direction == "up": self._position[1] += p2.y - p1.y - 1e-4
    elif direction == "right": self._position[0] += p2.x - p1.x - 1e-4
    else: self._position[0] -= p1.x - p2.x - 1e-4
  ...
  def _handle_circle_square(self, other, direction):
    ...
    if direction == "down":
      if other.vertices[1][0] > self.x:
        ...
        p = line1.intersection(circle)
        try: self._position[1] -= p.y - other.vertices[1][1]  - 1e-4
        except: pass
      elif other.vertices[0][0] < self.x:
        line1 = LineString([other.vertices[0], (other.vertices[0][0], self.y)])
        p = line1.intersection(circle)
        try: self._position[1] -= p.y - other.vertices[0][1] - 1e-4
        except: pass
      else: self._position[1] -= self.y - self.prop - other.bounds[3] - 1e-4
    elif direction == "up":
      if other.vertices[2][0] > self.x:
        line1 = LineString([(other.vertices[2][0], self.y), other.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[1] += other.vertices[2][1] - p.y  - 1e-4
        except: pass
      elif other.vertices[3][0] < self.x:
        line1 = LineString([(other.vertices[3][0], self.y), other.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[1] += other.vertices[3][1] - p.y  - 1e-4
        except: pass
      else: self._position[1] += other.bounds[1] - (self.y + self.prop)  - 1e-4
    elif direction == "right":
      if other.vertices[1][1] < self.y:
        line1 = LineString([(self.x, other.vertices[1][1]), other.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] += other.vertices[1][0] - p.x  - 1e-4
        except: pass
      elif other.vertices[2][1] > self.y:
        line1 = LineString([(self.x, other.vertices[2][1]), other.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[0] += other.vertices[2][0] - p.x  - 1e-4
        except: pass
      else: self._position[0] += other.bounds[0] - (self.x + self.prop)  - 1e-4
    else:
      if other.vertices[0][1] < self.y:
        line1 = LineString([other.vertices[0], (self.x, other.vertices[0][0])])
        p = line1.intersection(circle)
        try: self._position[0] -= p.x - other.vertices[0][0] - 1e-4
        except: pass
      elif other.vertices[3][1] > self.y:
        line1 = LineString([other.vertices[3], (self.x, other.vertices[3][0])])
        p = line1.intersection(circle)
        try: self._position[0] -= p.x - other.vertices[3][0] - 1e-4
        except: pass
      else: self._position[0] -= self.x - self.prop - other.bounds[2] - 1e-4
  ...
  def _handle_square_circle(self, other, direction):
    ...
    if direction == "down":
      if self.vertices[2][0] > other.x:
        ...
        p = line1.intersection(circle)
        try: self._position[1] -= self.vertices[2][1] - p.y - 1e-4
        except: pass
      elif self.vertices[3][0] < other.x:
        line1 = LineString([(self.vertices[3][0], other.y), self.vertices[3]])
        p = line1.intersection(circle)
        try: self._position[1] -= self.vertices[3][1] - p.y - 1e-4
        except: pass
      else: self._position[1] -= self.bounds[1] - (other.y + other.prop) - 1e-4
    elif direction == "up":
      if self.vertices[1][0] > other.x:
        line1 = LineString([self.vertices[1], (self.vertices[1][0], other.y)])
        p = line1.intersection(circle)
        try: self._position[1] += p.y - self.vertices[1][1] - 1e-4
        except: pass
      elif self.vertices[0][0] < other.x:
        line1 = LineString([self.vertices[0], (self.vertices[0][0], other.y)])
        p = line1.intersection(circle)
        try: self._position[1] += p.y - self.vertices[0][1] - 1e-4
        except: pass
      else: self._position[1] += other.y - other.prop - self.bounds[3] - 1e-4
    elif direction == "right":
      if self.vertices[3][1] > other.y:
        line1 = LineString([self.vertices[3], (other.x, self.vertices[3][1])])
        p = line1.intersection(circle)
        try: self._position[0] += p.x - self.vertices[3][0] - 1e-4
        except: pass
      elif self.vertices[0][1] < other.y:
        line1 = LineString([self.vertices[0], (other.x, self.vertices[0][1])])
        p = line1.intersection(circle)
        try: self._position[0] += p.x - self.vertices[0][0] - 1e-4
        except: pass
      else: self._position[0] += other.x - other.prop - self.bounds[2] - 1e-4
    else:
      if self.vertices[2][1] > other.y:
        line1 = LineString([(other.x, self.vertices[2][1]), self.vertices[2]])
        p = line1.intersection(circle)
        try: self._position[0] -= self.vertices[2][0] - p.x - 1e-4
        except: pass
      elif self.vertices[1][1] < other.y:
        line1 = LineString([(other.x, self.vertices[1][1]), self.vertices[1]])
        p = line1.intersection(circle)
        try: self._position[0] -= self.vertices[1][0] - p.x - 1e-4
        except: pass
      else: self._position[0] -= self.bounds[0] - (other.x + other.prop) - 1e-4

  def _handle_square_square(self, other, direction):
    if direction == "down":
      self._position[1] -= self.bounds[1] - other.bounds[3] - 1e-4
    elif direction == "up":
      self._position[1] += other.bounds[1] - self.bounds[3] - 1e-4
    elif direction == "right":
      self._position[0] += other.bounds[0] - self.bounds[2] - 1e-4
    else:
      self._position[0] -= self.bounds[0] - other.bounds[2] - 1e-4
  ...
  def _handle_square_triangle(self, other, direction):
    ...
    if direction == "down":
      if self_vert[3][0] < other_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] -= self_vert[3][1] - point.y  - 1e-4
        except: pass
      elif self_vert[2][0] > other_vert[0][0]:
        line1 = LineString([other_vert[0], other_vert[2]])
        line2 = LineString([(self_vert[2][0], 0), self_vert[2]])
        point = line1.intersection(line2)
        try: self._position[1] -= self_vert[2][1] - point.y  - 1e-4
        except: pass
      else:
        self._position[1] -= self.bounds[1] - other.bounds[3] - 1e-4
    elif direction == "up":
      ...
      if self.bounds[1] >= other.bounds[1]: 
        ...
        point = line1.intersection(line2)
        try: self._position[0] += point.x - self_vert[3][0]  - 1e-4
        except: pass
      else:
        self._position[0] += other.bounds[0] - self.bounds[2]  - 1e-4
    else:
  ...
  def _handle_triangle_square(self, other, direction):
    ...
    if direction == "down":
      ...
      if other_vert[3][0] < self_vert[0][0]:
        ...
        point = line1.intersection(line2)
        try: self._position[1] += other_vert[3][1] - point.y  - 1e-4
        except: pass
      elif other_vert[2][0] > self_vert[0][0]:
        line1 = LineString([self_vert[0], self_vert[2]])
        line2 = LineString([(other_vert[2][0], 0), other_vert[2]])
        point = line1.intersection(line2)
        try: self._position[1] += other_vert[2][1] - point.y  - 1e-4
        except: pass
      else:
        self._position[1] += other.bounds[1] - self.bounds[3] - 1e-4
    elif direction == "right":
      ...
      if self.bounds[1] >= other.bounds[1]:
        ...
        point = line1.intersection(line2)
        try: self._position[0] -= point.x - other_vert[3][0] - 1e-4
        except: pass
    del self_vert, other_vert
  ...
  def _handle_circle_triangle(self, other, direction):
    ...
    if direction == "down":
      if self.y - r >= other.vertices[0][1] and self.x - other.vertices[0][0] <= 0.02:
        self._position[1] -= self.y - r - other.bounds[3] - 1e-4
      else:  
        if self.x <= other.vertices[0][0]:
          p = self.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
          line2 = LineString([other.vertices[0], other.vertices[1]])
        ...
        d1, d2 = (0, 0)
        if line1.intersection(line2):
          d1 = p[1] - line1.intersection(line2).y  - 1e-4
        if line3.intersects(self.contours):
          d2 = line3.intersection(self.contours).bounds[1] - other.vertices[0][1] - 1e-4
        self._position[1] -= max(d1, d2) #if min(d1, d2) != 1 else 0
      ...
      if other.vertices[2][0] < self.x:
        ...
        point = line1.intersection(self.contours)
        try: self._position[1] += other.vertices[2][1] - point.bounds[3] - 1e-4
        except: pass
      elif other.vertices[1][0] > self.x:
        line1 = LineString([other.vertices[1], (other.vertices[1][0], self.y)])
        point = line1.intersection(self.contours)
        try: self._position[1] += other.vertices[1][1] - point.bounds[3] - 1e-4
        except: pass
      else: self._position[1] += other.bounds[1] - self.bounds[3] - 1e-4
    elif direction == "right":
      if self.bounds[1] == other.bounds[1]:
        line1 = LineString([other.vertices[0], other.vertices[1]])
        line2 = LineString([(self.bounds[2], self.y), (1, self.y)])
        point = line1.intersection(line2)
        try: self._position[0] += point.x - self.bounds[2] - 1e-4
        except: pass
      elif self.y - r <= other.vertices[0][1] and self.y - r > other.vertices[1][1]:
        p = self.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
        line1 = LineString([p, (1, self.y)])
        ...
        if line1.intersection(line2):
          ...
          d1 = point.x - p[0] - 1e-4
        if line3.intersects(self.contours):
          d2 = other.vertices[0][0] - line3.intersection(self.contours).bounds[2]   - 1e-4
      ...
      if self.bounds[1] == other.bounds[1]:
        line1 = LineString([other.vertices[0], other.vertices[2]])
        line2 = LineString([(0, self.y), (self.bounds[0], self.y)])
        point = line1.intersection(line2)
        try: self._position[0] -= self.bounds[0] - point.x - 1e-4
        except: pass
      elif self.y - r <= other.vertices[0][1] and self.y - r > other.vertices[1][1]:
        p = self.position + (r * np.cos((5*np.pi)/4), r * np.sin((5*np.pi)/4))
        line1 = LineString([(0, self.y), p])
        ...
        if line1.intersection(line2):
          ...
          d1 = p[0] - point.x - 1e-4
        if line3.intersects(self.contours):
          d2 = line3.intersection(self.contours).bounds[0] - other.vertices[0][0] - 1e-4
        self._position[0] -= max(d1, d2)
      else:
  ...
  def _handle_triangle_circle(self, other, direction):
    ...
    if direction == "down": 
      if self.vertices[2][0] < other.x:
        ...
        point = line1.intersection(other.contours)
        try: self._position[1] -= self.vertices[2][1] - point.bounds[3] - 1e-4
        except: pass
      elif self.vertices[1][0] > other.x:
        line1 = LineString([self.vertices[1], (self.vertices[1][0], other.y)])
        point = line1.intersection(other.contours)
        try: self._position[1] -= self.vertices[1][1] - point.bounds[3] - 1e-4
        except: pass
      else: self._position[1] -= self.bounds[1] - other.bounds[3] - 1e-4
    elif direction == "up":
      if not (other.x + 0.02 <= self.vertices[0][0] or other.x - 0.02 >= self.vertices[0][0]):
        self._position[1] += other.y - r - self.bounds[3] - 1e-4
      else:
        if other.x <= self.vertices[0][0]:
          p = other.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
          line2 = LineString([self.vertices[0], self.vertices[1]])
        ...
        if line1.intersection(line2):
          ...
          d1 = p[1] - point.y - 1e-4
        if line3.intersects(other.contours):
          d2 = line3.intersection(other.contours).bounds[1] - self.vertices[0][1] - 1e-4
        self._position[1] += max(d1, d2) # if min(d1, d2) != 1 else 0
    elif direction == "right":
      if self.vertices[2][1] >= other.y + r * np.sin((5*np.pi)/4):
        ...
        if p1: self._position[0] += p1[0][0] - self.vertices[2][0] - 1e-4
      elif self.vertices[0][1] < other.y + r * np.sin((5*np.pi)/4):
        p1 = other.polygon.intersection(LineString([self.vertices[2], other.position]))
        p1 = [p for p in list(p1.coords) if Point(p) != Point(other.position)]
        if p1: self._position[0] += p1[0][0] - self.vertices[0][0] - 1e-4
      ...
      if self.vertices[1][1] >= other.y + r * np.sin((7*np.pi)/4):
        ...
        p1 = [p for p in list(p1.coords) if Point(p) != Point(other.position)]
        if p1: self._position[0] -= self.vertices[1][0] - p1[0][0] - 1e-4
      elif self.vertices[0][1] < other.y + r * np.sin((7*np.pi)/4):
  ...
  def _handle_triangle_triangle(self, other, direction):
    ...
    if direction == "down":
      if self_vert[2][0] < other_vert[0][0]:
        ...
        line2 = LineString([other_vert[0], other_vert[2]])
        point = line1.intersection(line2)
        try: self._position[1] -= self_vert[1][1] - point.y - 1e-4
        except: pass
      else:
        self._position[1] -= self.bounds[1] - other.bounds[3] - 1e-4
    elif direction == "up":
      if other_vert[2][0] < self_vert[0][0]:
        ...
        line2 = LineString([self_vert[0], self_vert[2]])
        point = line1.intersection(line2)
        try: self._position[1] += other_vert[1][1] - point.y - 1e-4
        except: pass
      else:
        self._position[1] += other.bounds[1] - self.bounds[3] - 1e-4
    elif direction == "right":
      if self.bounds[1] > other.bounds[1]:
        ...
        line2 = LineString([self_vert[0], self_vert[2]])
        point = line1.intersection(line2)
        try: self._position[0] += other_vert[1][0] - point.x - 1e-4
        except: pass
      else:
        self._position[0] += other.bounds[0] - self.bounds[2] - 1e-4
    else:
      if self.bounds[1] > other.bounds[1]:
        ...
        line2 = LineString([other_vert[0], other_vert[2]])
        point = line1.intersection(line2)
        try: self._position[0] -= self_vert[1][0] - point.x - 1e-4
        except: pass
      elif self.bounds[1] < other.bounds[1]:
  ...
  def circle_triangle_distance(self, other, direction):
    ...
    if direction == "down":
      if self.y - r >= other.vertices[0][1] and self.x - other.vertices[0][0] <= 0.02:
        return self.y - r - other.bounds[3]
      else:  
        if self.x <= other.vertices[0][0]:
          p = self.position + (r * np.cos((7*np.pi)/4), r * np.sin((7*np.pi)/4))
          line2 = LineString([other.vertices[0], other.vertices[1]])
        ...
        return max(d1, d2) #if min(d1, d2) != 1 else 0
         
    elif direction == "up":
      if other.vertices[2][0] < self.x:
        line1 = LineString([other.vertices[2], (other.vertices[2][0], self.y)])
        point = line1.intersection(self.contours)
        try: return other.vertices[2][1] - point.bounds[3]
        except: return 1
      elif other.vertices[1][0] > self.x:
        line1 = LineString([other.vertices[1], (other.vertices[1][0], self.y)])
        point = line1.intersection(self.contours)
        try: return other.vertices[1][1] - point.bounds[3]
        except: return 1
      else: return other.bounds[1] - self.bounds[3]
    elif direction == "right":
      ...
      if self.y - r <= other.vertices[0][1] and self.y - r >= other.vertices[1][1]:
        ...
        line2 = LineString(self.vertices)
        p = line1.intersection(line2)
        try: return p.x - other.vertices[2][0]
        except: return 1
  ...
  def triangle_circle_distance(self, other, direction):
    ...
    if direction == "down": 
      if self.vertices[2][0] < other.x:
        line1 = LineString([self.vertices[2], (self.vertices[2][0], other.y)])
        point = line1.intersection(other.contours)
        try: return self.vertices[2][1] - point.bounds[3]
        except: return 1
      elif self.vertices[1][0] > other.x:
        line1 = LineString([self.vertices[1], (self.vertices[1][0], other.y)])
        point = line1.intersection(other.contours)
        try: return self.vertices[1][1] - point.bounds[3]
        except: return 1
      else: return self.bounds[1] - other.bounds[3]
    elif direction == "up":
      if not (other.x + 0.02 <= self.vertices[0][0] or other.x - 0.02 >= self.vertices[0][0]):
